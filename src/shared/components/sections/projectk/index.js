            ...
            <div className="col-xs-12 col-sm-6">
              ...
              <div style={ { marginBottom: '45px' } }>
                <Par1>
                  ...
                  ya que él cree firmemente en la idea de que la educación es la base de una
                  sociedad en progreso inspirados en la filosofía de San Maximiliano Kobe –
                </Par1>
              </div>
              <Par1>
        ...
        <div className="container">
          <div className="row" style={ { marginBottom: '78px' } }>
            <div className="col-xs-12 col-sm-6">
              ...
              <Par2>
                ...
                cristiana que tiene al hombre y a la mujer como centro y preocupación de toda
                su actividad.
              </Par2>
              <Title14>
              ...
              <Par1>
                La preparación y celebración se lleva a cabo cada año con los alumnos cuyos
                padres así lo deseen.
              </Par1>
              <Par1>
            ...
            <div className="col-xs-12 col-sm-6">
              ...
              <List4>
                <li>
                  La educación a favor del hombre y de la mujer creados a imagen
                  y semejanza de Dios.
                </li>

                <li>
                  La educación a favor de la cultura de la vida, de la cultura de la paz y
                  de la cultura del bien común.
                </li>

                <li>
                  La educación para el éxito, para la excelencia y para la eficiencia
                  profesional.
                </li>
                ...
                <li>
                  La educación como gestora de una cultura de la solidaridad,
                  la justicia social y la armonía social.
                </li>

                <li>
                  La educación bajo la mística del servicio al marginado al estilo
          ...
          <div className="row" style={ { marginBottom: '180px' } }>
            ...
            <div className="col-xs-12 col-sm-6">
              ...
              <Par1>
                Certificación como escuela dentro del BEO BOARD. Cada año se llevan a
                cabo las Olimpiadas Británicas de Inglés en donde las escuelas más
                exclusivas del Reino Unido reciben a un grupo de estudiantes de todo
                el mundo se enfrentan a diferentes retos académicos en el idioma Inglés.
              </Par1>
              <Title17>
                Objetivos y ventjas
              </Title17>
              <List4>
                <li>
                  Fortalece el aprendizaje integral para la excelencia en el uso
                  del idioma inglés.
                </li>
          ...
          <div className="container">
            <div className="row">
              <div className="col-xs-12 col-sm-4 col-sm-offset-1">
                ...
                <Par5>
                  San Maximiliano Kolbe, Bendice el trabajo que estamos iniciando
                  este nuevo día, bendice a nuestro padres, bendice su trabajo y
                  cuídalos de toda enfermedad. Bendice a nuestros maestros y a toda su familia,
