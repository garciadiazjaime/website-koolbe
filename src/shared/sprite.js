module.exports = {
    "General": {
        "Facebook": {
            ...
            "width": "23px",
            "height": "23px",
            "backgroundImage": "url('http://127.0.0.1:3000/images/sprites/sprite-general.png')",
    ...
    "Home": {
        "Beo": {
            ...
            "width": "272px",
            "height": "169px",
            "backgroundImage": "url('http://127.0.0.1:3000/images/sprites/sprite-home.png')",
            "backgroundSize": "544px 338px"
        },
        "Extraescolares": {
            "backgroundPosition": "-272px -0px",
            "width": "272px",
            "height": "169px",
            "backgroundImage": "url('http://127.0.0.1:3000/images/sprites/sprite-home.png')",
            "backgroundSize": "544px 338px"
    ...
    "HomeSliderProyectok": {
        "AEscuela": {
            ...
            "width": "514px",
            "height": "351px",
            "backgroundImage": "url('http://127.0.0.1:3000/images/sprites/sprite-home-slider-proyectok.png')",
