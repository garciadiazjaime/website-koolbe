...
var SimpleCard = function (_Component) {
  ...
  _createClass(SimpleCard, [{
    ...
    value: function getSprite(data, index) {
      if (data && data.style) {
        return _react2.default.createElement('div', { key: index, style: data.style });
      }
      return null;
    }
  }, {
    ...
    value: function render() {
      ...
      if (_lodash2.default.isArray(this.props.data.elements) && this.props.data.elements.length) {
        var wrapperStyle = this.getWrapper(this.props.data.wrapper);
        var Components = this.props.data.elements.map(function (item, index) {
